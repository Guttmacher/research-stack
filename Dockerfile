...
RUN set -e; \
    ...
    python3.13 -m pip install black flake8 mypy isort uv cmdstanpy pystan arviz xarray pandas numpy matplotlib seaborn jax numpyro torch pyro-ppl scikit-learn scipy && \
    # Verify installation
    python3 --version && \
    python3.13 --version && \
